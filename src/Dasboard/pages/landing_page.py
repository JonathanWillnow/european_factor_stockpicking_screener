...
layout =  html.Div(
    children=[
        ...
        html.H1(children="A simple guide", className="header-title-2"),
            html.P(
                children=[
                    html.P("Ever wondered which is the best stock out of the EuroStoxx600 based on the Fama French Quality Score but you were to lazy to calculate it yourself?"
                    + " This is just one thing that you can easily look up using this App."),
                    html.P("For a start, select one of the four different regions for which there is currently data available."
                    ...
                    + "(max 10 years) stockchart will appear as well as a selection of important information about the company, provided via the"
